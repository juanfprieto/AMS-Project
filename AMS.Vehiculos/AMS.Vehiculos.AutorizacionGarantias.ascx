...
<asp:placeholder id="plcSeleccion" runat="server">
				...
				<FIELDSET>
                <LEGEND class="Legends">Selección de la Orden</LEGEND>
...
<asp:placeholder id="plcInformacion" runat="server" Visible="False">
				...
				<FIELDSET><LEGEND class="Legends">Factura de Entrega al Cliente</LEGEND>
					<TABLE class="main" cellSpacing="10">
						<TR>
							<TD vAlign="top">
					...
					<FIELDSET><LEGEND class="Legends">Información Entrega Inicial</LEGEND>
						<TABLE class="main" cellSpacing="10">
							<TR>
								<TD>
