	...
	<table id="Table1" class="filtersIn">
		<tbody>
			<TR>
				<TD>Proceso:
				<br>
					<asp:dropdownlist id="ddlProceso" class="dmediano" runat="server" OnSelectedIndexChanged="ddlProceso_SelectedIndexChanged" AutoPostBack ="True"
>
			...
			<TR>
				<td>
					...
					<div id="div_ddlCriterioSeleccionUbicaciones"><asp:dropdownlist id="ddlCriterioSeleccionUbicaciones" OnChange="CambioCriterioSeleccionUbicaciones();"
                        ...
                        <p>
                        <asp:button id="btnRealizar" onclick="generar_Inventario" onClientClick = "espera();" runat="server" Text="Generar" class = "noEspera" AutoPostBack="True"> 
                        </asp:button>
                        </p>
				</td>
			</TR>
