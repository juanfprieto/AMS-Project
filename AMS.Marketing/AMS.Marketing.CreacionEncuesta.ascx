...
<fieldset>
		...
		<TABLE id="Table1" class="filtersIn">
			...
			<TR>
				...
				<TD>
					<asp:textbox id="TbNombre" runat="server" Width="280px"></asp:textbox>&nbsp;
			...
			<TR>
				...
				<TD>
					<asp:textbox id="TbRespon" runat="server" Width="280px"></asp:textbox>&nbsp;
			...
			<TR>
				...
				<TD>
					<asp:TextBox id="tbobj" runat="server" Width="280px"></asp:TextBox>
