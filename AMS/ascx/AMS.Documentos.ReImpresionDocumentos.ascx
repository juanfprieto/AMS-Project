<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AMS.Documentos.ReImpresionDocumentos.ascx.cs" Inherits="AMS.Documentos.ReImpresionDocumentos" %>
...
<fieldset id="Fieldset1" runat="server" >
    ...
    <table class="filtersIn">
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlPrefijo" Runat="server" Height="30px">
                </asp:DropDownList>
            </td>
            <td id="Td1" runat="server"><asp:Image id="imglupita" runat="server" ImageUrl="../img/AMS.Search.png" onClick ="crgPrefijoDoc();"></asp:Image></td>
        </tr>
        <tr>
            <td>
...
<fieldset id="Fieldset2" runat="server" >
    ...
    <table class="filtersIn">
        <tr>
            <td colspan="2">
                <p>
                    Aquí usted podra reimprimir un documento generado con anterioridad que corresponda <i>exclusivamente
                    a pedidos de items de inventario,</i> dicho documento debe tener un formato asociado por la opción de
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlPrefPed" Runat="server" AutoPostBack="True" onselectedindexchanged="ddlPrefPed_SelectedIndexChanged" Height="30px">
                </asp:DropDownList>
            </td>
        ...
        <tr>
            ...
            <td>
                <asp:DropDownList ID="ddlNumPed" class="dpequeno" Runat="server" Height="30px">
                </asp:DropDownList>
            </td>
        </tr>
        <tr>
