	...
	<FIELDSET>
		...
		<TABLE class="filtersIn">
			<TR>
				...
				<TD>
					<asp:Label id="lbInfo3" runat="server" forecolor="RoyalBlue">Tipo de Vehículo :</asp:Label>
...
<FIELDSET>
	...
	<TABLE class="filtersIn">
		<TR>
			<TD>
				<asp:Label id="lbInfo26" runat="server" forecolor="RoyalBlue">Valor Vehículo :</asp:Label>
		...
		<TR>
			<TD colSpan="3">
                ...
                *Los elementos seleccionados se facturarán por medio de una factura administrativa y NO se descontaran de inventario.
                </asp:Label></center>
                </P>
			</TD>
		</TR>
