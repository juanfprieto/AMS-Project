<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AMS.Comercial.PlanillaGiros.ascx.cs" Inherits="AMS.Comercial.AMS_Comercial_PlanillaGiros" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
				...
				<td vAlign="middle">
					...
					<p>
						<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="300" border="0">
							<TR>
								<TD style="WIDTH: 98px"><asp:label id="PlacaLabel" runat="server">Agencia</asp:label></TD>
								<td><asp:dropdownlist id="Agencia" runat="server" OnSelectedIndexChanged="generar" Width="250px"></asp:dropdownlist></TD>
							</TR>
							<TR>
							</TR>
						</TABLE>
		...
		<tr>
			<td align="center">
				<p><asp:datagrid id="Grid" runat="server" Width="780px" HorizontalAlign="Center" AutoGenerateColumns="False">
						...
						<Columns>
							<asp:TemplateColumn HeaderText="NUMERO GIRO">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "NUMEROGIRO") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							...
							<asp:TemplateColumn HeaderText="CEDULA EMISOR" ItemStyle-HorizontalAlign="center">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "CEDULAEMISOR") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="NOMBRE DESTINATARIO" ItemStyle-HorizontalAlign="left">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "NOMBRERECEPTOR") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="CEDULA DESTINATARIO" ItemStyle-HorizontalAlign="center">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "CEDULARECEPTOR") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="VALOR GIRO" ItemStyle-HorizontalAlign="Right">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "VALORGIRO") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="COSTO GIRO" ItemStyle-HorizontalAlign="Right">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "COSTOGIRO") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="ESTADO" ItemStyle-HorizontalAlign="center">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "ESTADOGIRO") %>
								</ItemTemplate>
							</asp:TemplateColumn>
						</Columns>
					</asp:datagrid></p>
