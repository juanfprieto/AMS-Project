...
<script type="text/javascript">     
    ...
    function Mostrar_Alerta()
    {
        ...
        alert('Paso1: Seleccione la tabla dentro del archivo que desea subir y asígnele el nombre RECEPCION. \nPaso2: Los nombres de los campos deben ser: \nCATALOGO\nPREFIJO(Tipo FP, ojo: sólo escriba el prefijo)\nFACTURA ej: F-12345\nVIN\nMOTOR\nSERIE\nCHASIS\nAÑO MODELO\nCOLOR\nVALOR\nTIPO SERVICIO\nNUMERO MANIFIESTO formato: (yyyy-mm-dd) ej: 2016-09-19\nFECHA MANIFIESTO formato: (yyyy-mm-dd)\nNUMERO ADUANA\nFECHA LEVANTE formato: (yyyy-mm-dd)\nNUMERO LEVANTE\nFECHA ENTRADA formato: (yyyy-mm-dd)\nFECHA VENCE formato: (yyyy-mm-dd)\nFECHA DISPONIBLE formato: (yyyy-mm-dd)\nNUMERO DO\nALMACEN \nNota1: El campo COLOR debe tener el código del color. \nNota2: El campo VALOR debe tener sólo números(sin pesos($) ni comas(,)).')
    }
</script>
                    ...
                    <table>
                        <tbody>
                            <tr>
                                <td>
                                    Proveedor :
                                        <asp:DropDownList id="ddlProv" runat="server" Width="250px"></asp:DropDownList>
