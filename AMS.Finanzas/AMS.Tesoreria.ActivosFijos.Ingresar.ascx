<%@ Control Language="C#" codebehind="AMS.Finanzas.Tesoreria.ActivosFijos.Ingresar.ascx.cs" autoeventwireup="True" Inherits="AMS.Finanzas.Tesoreria.IngresarActivosFijos" %>
...
<asp:Panel id="pnlDatos" runat="server">
	<TABLE>
		...
		<TR>
			...
			<TD>
				<asp:TextBox id="tbdesc" runat="server" MaxLength="200" Width="241px" TextMode="MultiLine"></asp:TextBox>
		...
		<TR>
			...
			<TD>
				<asp:TextBox id="tbmarca" runat="server" MaxLength="30" Width="250px"></asp:TextBox>
		...
		<TR>
			...
			<TD>
				<asp:TextBox id="tbmodelo" runat="server" MaxLength="10" Width="250px"></asp:TextBox>
		...
		<TR>
			...
			<TD>
				<asp:TextBox id="tbplaca" runat="server" MaxLength="10" Width="250px"></asp:TextBox>
	...
	<asp:Panel id="pnlCuentas" runat="server" Visible="False">
		<TABLE height="347" width="520">
			...
			<TR>
				...
				<TD>
					<asp:TextBox id="tbcuereal" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
			...
			<TR>
				...
				<TD>
					<asp:TextBox id="tbcuedep" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
						runat="server" MaxLength="16" ToolTip="Haga doble click para iniciar la busqueda"></asp:TextBox>
			...
			<TR>
				...
				<TD>
					<asp:TextBox id="tbcuegasdep" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
						runat="server" MaxLength="16" ToolTip="Haga doble click para iniciar la busqueda"></asp:TextBox>
			...
			<TR style="display:none">
				...
				<TD>
					<asp:TextBox id="tbcueinf" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
						runat="server" MaxLength="16" ToolTip="Haga doble click para iniciar la busqueda"></asp:TextBox>
			...
			<TR style="display:none">
				...
				<TD>
					<asp:TextBox id="tbcueinfdep" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
						runat="server" MaxLength="16" ToolTip="Haga doble click para iniciar la busqueda"></asp:TextBox>
			...
			<TR style="display:none">
				...
				<TD>
					<asp:TextBox id="tbcormoninf" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
			...
			<TR style="display:none">
				...
				<TD>
					<asp:TextBox id="tbcormondep" ondblclick="ModalDialog(this,'SELECT mcue_codipuc AS Cuenta,mcue_nombre AS Descripcion FROM mcuenta WHERE timp_codigo IN(\'A\',\'P\')',new Array())"
						runat="server" MaxLength="16" ToolTip="Haga doble click para iniciar la busqueda"></asp:TextBox></TD>
			</TR>
		</TABLE>
	</asp:Panel>
...
<p>
	<asp:LinkButton id="lnbAnt" runat="server" Enabled="False" CausesValidation="False" onCommand="lnbAnt_Command">Anterior</asp:LinkButton>
	&nbsp;&nbsp;
