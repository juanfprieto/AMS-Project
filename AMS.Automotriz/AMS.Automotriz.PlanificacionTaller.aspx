	...
	<body>
    	<form id="Form1" method="post" runat="server">
            ...
            <table id="Table1" class="titulo">
	            <tr>
		            <td width="10%" height="50"><asp:Image id="Image1" runat="server" width="100"/></td>
	            ...
	            <tr>
		            <td colspan="2">
			            Estado Operaciones:
                        <div class="estBlanco">Asignada</div>
                        <div class="estmorado">Pndt. Rpto</div>
			            <div class="estazul">Pndt. Hmt</div>
			            <div class="estcafe">Aus. Mec.</div>
			            <div class="estverdeClaro">Inic. Op.</div>
                        <div class="estMetal">Pndt. Otro</div>
                        <div class="esServicio">
                            <img src="../img/espera2.png" title="Serv. Inmediato"  runat="server"/>
                        </div>
