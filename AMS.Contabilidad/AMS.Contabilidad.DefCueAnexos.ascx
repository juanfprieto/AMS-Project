			   ...
			   <IMG height="70" src="../img/AMS.Flyers.Filters.png" border="0">
					...
					<td>
                        ...
                        Año:
                            ...
                            <br />Clase: 
                            <asp:dropdownlist id="clase" class="dmediano" runat="server"></asp:dropdownlist>
                            <br />
                            <asp:Panel height="15%" GroupingText="Periodo:" width="65%" runat="server">
                            <asp:radiobuttonlist  id="opciones" runat="server"  repeatdirection="Horizontal" >
			...
			<tr>
				<td align="center">
					<p><asp:datagrid id="Grid" runat="server" cssclass="datagrid" AutoGenerateColumns="False" onselectedindexchanged="Grid_SelectedIndexChanged">
							...
							<Columns>
								<asp:TemplateColumn HeaderText="CODIGO DEL RENGLON ó LINEA" ItemStyle-HorizontalAlign="Left">
									<ItemTemplate>
										<%# DataBinder.Eval(Container.DataItem, "NUMERO") %>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="NOMBRE DEL RENGLON ó LINEA">
									<ItemStyle HorizontalAlign="Center"></ItemStyle>
									<ItemTemplate>
										<%# DataBinder.Eval(Container.DataItem, "NOMBRE") %>
									</ItemTemplate>
								</asp:TemplateColumn>
								<asp:TemplateColumn HeaderText="TOTAL DEL RENGLON ó LINEA" ItemStyle-HorizontalAlign="Right">
									<ItemTemplate>
