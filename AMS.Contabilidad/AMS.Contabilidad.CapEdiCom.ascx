			...
			<tr>
				...
				<td>
					...
					<p>Tipo:
						...
						&nbsp;<asp:panel id="Panel1" runat="server" Width="344px" BorderWidth="1px" BorderStyle="Solid" BackColor="#E0E0E0">Mes y año fiscal vigente: 
                        <asp:Label id="maVig" runat="server" backcolor="#E0E0E0"></asp:Label></asp:panel><br/>
                        <asp:Panel runat="server" Width="344px" BorderWidth="1px" BorderStyle="Solid"><legend>Consecutivo</legend>
						<asp:radiobuttonlist id="rblConsecutivo" runat="server" ForeColor="Gray" RepeatDirection="horizontal">
							<asp:ListItem Value="true" Selected="True">Autom&#225;tico</asp:ListItem>
                            <asp:ListItem Value="false">Manual</asp:ListItem>
						</asp:radiobuttonlist></p>
                        </asp:Panel>
                        </asp:Label> * NO impute aqui documentos (prefijos) que son utilizados en los módulos y que generan consecutivo automático.</asp:Label>
