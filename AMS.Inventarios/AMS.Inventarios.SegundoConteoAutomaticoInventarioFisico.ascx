...
<fieldset>
	...
	<table id="Table1" class="filtersIn">
        ...
        <tr>         
			<td colspan="2">El proceso de Segundo Conteo Automático de inventario físico genera el SEGUNDO CONTEO IGUAL al PRIMER CONTEO y CALCULA las DIFERENCIAS del Inventario Físico:   <br />
            </td>            
      	</tr>
		
        <tr>
			<td colspan="2"><asp:button id="btnCerrar" runat="server" Text="Realizar Segundo Conteo Automático Inventario Físico" onclick="btnCerrar_Click" ></asp:button>&nbsp;
