...
namespace AMS.Automotriz
{
	...
	public partial class HojaVidaSinPrecio : System.Web.UI.UserControl
	{
		...
		protected void dgTable_Procesos(object sender, DataGridCommandEventArgs e) 
		{
			...
			{
                Response.Redirect("" + indexPage + "?process=Automotriz.HojaVida.ConsultarHojaUsuario&placa=" + dgrCatalogos.DataKeys[e.Item.ItemIndex].ToString() + "");
			}
		}
