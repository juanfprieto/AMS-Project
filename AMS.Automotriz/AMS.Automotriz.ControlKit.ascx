		...
		<tbody>
			<tr> 
				<td>Código del Kit :<br>
					<asp:textbox id="tbCodigoKit" class="tmediano" runat="server" MaxLength="10" Enabled="False"></asp:textbox>
				...
				<td>Descripción del Kit :<br>
                    <asp:textbox id="tbNombreKit" class="tmediano" runat="server" Width="366px" MaxLength="60"></asp:textbox>
			...
			<tr>
				<td>Grupo de Catálogo :<br>
					<asp:dropdownlist id="ddlGrupos" class="dmediano" runat="server" Enabled="true"></asp:dropdownlist>
                </td>
