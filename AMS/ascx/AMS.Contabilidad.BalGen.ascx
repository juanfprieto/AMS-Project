<%@ Control Language="c#" codebehind="AMS.Contabilidad.BalGen.ascx.cs" autoeventwireup="True" Inherits="AMS.Contabilidad.BalGen" %>
		...
		<p>
			<asp:PlaceHolder id="toolsHolder" runat="server" visible="false">
				<TABLE class="tools" width="780">
					<TR>
						<TD><IMG height="30" src="../img/AMS.Flyers.Tools.png" border="0"></TD>
					...
					<tr>
						<td>
							<ASP:DataGrid id="report" runat="server" cssclass="datagrid" BorderWidth="2px" GridLines="None"
								CellPadding="3" CellSpacing="1" EnableViewState="False" OnItemDataBound="Report_ItemDataBound"
								autogeneratecolumns="false" AllowSorting="true" BorderStyle="Ridge" BorderColor="White">
