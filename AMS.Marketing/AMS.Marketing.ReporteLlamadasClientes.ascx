...
<p><asp:placeholder id="phReporte" runat="server">
		<TABLE id="Table3" class="filtersIn">
				...
				<TD>
					...
					<asp:DataGrid id="dgContacto0" runat="server" cssclass="datagrid" CellPadding="3"
						...
						<Columns>
							...
							<asp:BoundColumn DataField="PVEN_NOMBRE" HeaderText="Vendedor" />
                            <asp:BoundColumn DataField="PALM_DESCRIPCION" HeaderText="Sede" />
							<asp:BoundColumn DataField="TELS" HeaderText="Telefonos" />
							<asp:BoundColumn DataField="EMAIL" HeaderText="email" />
						</Columns>
					</asp:DataGrid></div></TD>
			...
			<TR>
				<TD><a href="javascript:toggle_div('div19');">
					<asp:Label id="lbTitulo19" runat="server"></asp:Label></a></TD>
			</TR>
			<TR>
				<TD></TD>
			</TR>
            <TR>
				<TD><div id="div19">
					<asp:DataGrid id="dgdias" runat="server" CellPadding="3"
						AutoGenerateColumns="False" ShowFooter="False">
						<FooterStyle cssclass="footer"></FooterStyle>
						<HeaderStyle font-bold="True" cssclass="header"></HeaderStyle>
						<PagerStyle cssclass="pager" mode="NumericPages"></PagerStyle>
            ...
            <TR>
				<TD><a href="javascript:toggle_div('div18');">
					<asp:Label id="lblTitulo17" runat="server"></asp:Label></a></TD>
			</TR>
            <TR>
				<TD><div id="div18">
					<asp:DataGrid id="dgrseismeses" runat="server" cssclass="datagrid" CellPadding="3" AutoGenerateColumns="False"
						ShowFooter="False">
						<FooterStyle cssclass="footer"></FooterStyle>
						<HeaderStyle font-bold="True" cssclass="header"></HeaderStyle>
						<PagerStyle cssclass="pager" mode="NumericPages"></PagerStyle>
						...
						<Columns>
                            ...
                            <asp:BoundColumn DataField="Catalogo" HeaderText="Catalogo" />
                            <asp:BoundColumn DataField= "Ultima_Entrada" HeaderText="Ultima Entrada" DataFormatString="{0:yyyy-MM-dd}" />
                            <asp:BoundColumn DataField="Propietario" HeaderText="Propietario" />
							<asp:BoundColumn DataField="Dirección" HeaderText="Dirección" />
                            <asp:BoundColumn DataField="Teléfono" HeaderText="Direccion" />
            ...
            <TR>
				<TD><a href="javascript:toggle_div('div15');">
					<asp:Label id="lblTitulo14" runat="server"></asp:Label></a></TD>
			</TR>
            <TR>
				<TD><div id="div15">
					<asp:DataGrid id="dgrvehiculosunano" runat="server" cssclass="datagrid" CellPadding="3" AutoGenerateColumns="False"
						ShowFooter="False">
						<FooterStyle cssclass="footer"></FooterStyle>
						<HeaderStyle font-bold="True" cssclass="header"></HeaderStyle>
						<PagerStyle cssclass="pager" mode="NumericPages"></PagerStyle>
            ...
            <TR>
				<TD><a href="javascript:toggle_div('div16');">
					<asp:Label id="lblTitulo15" runat="server"></asp:Label></a></TD>
			</TR>
            <TR>
				<TD><div id="div16">
					<asp:DataGrid id="dgrdosanos" runat="server" cssclass="datagrid" CellPadding="3" AutoGenerateColumns="False"
						ShowFooter="False">
						<FooterStyle cssclass="footer"></FooterStyle>
						<HeaderStyle font-bold="True" cssclass="header"></HeaderStyle>
						<PagerStyle cssclass="pager" mode="NumericPages"></PagerStyle>
            ...
            <TR>
				<TD><a href="javascript:toggle_div('div17');">
					<asp:Label id="lblTitulo16" runat="server"></asp:Label></a></TD>
			</TR>
            <TR>
				<TD><div id="div17">
					<asp:DataGrid id="dgrclipotencial" runat="server" cssclass="datagrid" CellPadding="3" AutoGenerateColumns="False"
						ShowFooter="False">
						<FooterStyle cssclass="footer"></FooterStyle>
						<HeaderStyle font-bold="True" cssclass="header"></HeaderStyle>
						<PagerStyle cssclass="pager" mode="NumericPages"></PagerStyle>
						...
						<Columns>
							<asp:TemplateColumn HeaderText="Nit o CC del Cliente" HeaderStyle-HorizontalAlign="Center">
								<ItemTemplate>
									<a href='<%=indexPage%>?process=Marketing.AccionMarketing&idCli=<%# DataBinder.Eval(Container.DataItem, "CC") %>&idVen=<%# DataBinder.Eval(Container.DataItem, "PVEN_CODIGO")  %>&Activ=CV&tipo=<%=Tipo%>&path=Accion Marketing'>
										<%# DataBinder.Eval(Container.DataItem, "CC") %>
									</a>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:BoundColumn DataField="NOMBRE" HeaderText="Nombre" />
                            <asp:BoundColumn DataField= "FECHA_CONTACTAR" HeaderText="FECHA_CONTACTAR" DataFormatString="{0:yyyy-MM-dd}" />
                            <asp:BoundColumn DataField="DETALLE" HeaderText="Detalle" />
                            <asp:BoundColumn DataField="TELEFONO" HeaderText="Telefono" />
							<asp:BoundColumn DataField="CELULAR" HeaderText="Celular" />
                            <asp:BoundColumn DataField="CIUDAD" HeaderText="Ciudad" />
                            <asp:BoundColumn DataField="MERCADERISTA" HeaderText="Asesor" />
						</Columns>
					</asp:DataGrid></div></TD>
			</TR>
