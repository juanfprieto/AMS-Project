...
<script type="text/javascript">  
    $(function ()
    {
        $("#<%=tbDate1.ClientID%>").datepicker({ dateFormat: 'yy-mm-dd' });
        $("#<%=tbDate1.ClientID%>").datepicker();
        $("#<%=tbDate1.ClientID%>").datepicker("option", "showAnim", "slideDown");
        $("#<%=tbDate1.ClientID%>").datepicker("option", "showOn", "button");
        $("#<%=tbDate1.ClientID%>").datepicker("option", "buttonImage", "../img/AMS.Icon.Calendar.png");
        $("#<%=tbDate1.ClientID%>").datepicker("option", "buttonImageOnly", "true");
        $("#<%=tbDate1.ClientID%>").datepicker("option", "buttonText", "Seleccionar Fecha");
        $("#<%=tbDate1.ClientID%>").val();

        $("#<%=tbDate2.ClientID%>").datepicker({ dateFormat: 'yy-mm-dd' });
        $("#<%=tbDate2.ClientID%>").datepicker();
        $("#<%=tbDate2.ClientID%>").datepicker("option", "showAnim", "slideDown");
        $("#<%=tbDate2.ClientID%>").datepicker("option", "showOn", "button");
        $("#<%=tbDate2.ClientID%>").datepicker("option", "buttonImage", "../img/AMS.Icon.Calendar.png");
        $("#<%=tbDate2.ClientID%>").datepicker("option", "buttonImageOnly", "true");
        $("#<%=tbDate2.ClientID%>").datepicker("option", "buttonText", "Seleccionar Fecha");
        $("#<%=tbDate2.ClientID%>").val();
    });
									...
									<TABLE>
										...
										<TR>
											...
											<TD vAlign="top" align="right">Año:
												...
												Fecha1:&nbsp;&nbsp;
												<asp:TextBox id="tbDate1" runat="server" class="tpequeno" ReadOnly="True">

												</asp:TextBox>
                                                <%--<IMG onmouseover="calendar1.style.visibility='visible'" onmouseout="calendar1.style.visibility='hidden'"
												...
												Fecha2:&nbsp;&nbsp;
												<asp:TextBox id="tbDate2" runat="server" class="tpequeno" ReadOnly="True"></asp:TextBox>
                                                <%--<img onmouseover="calendar2.style.visibility='visible'" onmouseout="calendar2.style.visibility='hidden'"
													src="../img/AMS.Icon.Calendar.gif" border="0">--%>
