...
<body>
	...
	<form id="form1" runat="server">
        ...
        style="background-image: linear-gradient(to bottom,#337ab7 0,#265a88 100%); background-repeat: repeat-x; border-color: #245580; color: #fff;background-color: #337ab7;padding: 6px 12px;font-size: 14px;
	...
	<p>
        ...
        <asp:PlaceHolder ID="plcVisibilityPanel" runat="server" ></asp:PlaceHolder><br />
