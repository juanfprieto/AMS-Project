<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AMS.Comercial.RecepcionPapeleria.ascx.cs" Inherits="AMS.Comercial.AMS_Comercial_RecepcionPapeleria" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
