...
namespace AMS.Tools
{
    public partial class PlanillaTercerosBancolombia : System.Web.UI.UserControl
    {
        ...
        protected void IniciarProceso(object sender, EventArgs e)
        {
            ...
            DBFunctions.Request(DatosCuerpo, IncludeSchema.NO, "CALL DBXSCHEMA.PLANO_PAGOSTERBANCOLOMBIA(" + "'" + TXTPREFIJO.Text + "'" + "," + numero   + " )");
            textoArch = "";
