<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="AMS.Vehiculos.FacturacionTramite.ascx.cs" Inherits="AMS.Vehiculos.FacturacionTramite" %>
...
<script type="text/javascript">
        ...
        function abrirEmergente()
    {
        var nit = document.getElementById('<%=txtNit.ClientID%>');
            ModalDialog(nit, 'SELECT DISTINCT M.MNIT_NIT AS NIT, NOMBRE AS NOMBRES FROM MORDENTRAMITE M, VMNIT VM WHERE m.test_estado = \'A\' and M.MNIT_NIT = VM.MNIT_NIT ORDER BY 2;', new Array(), 1);
...
<P><asp:button id="guardar" runat="server" Enabled="False" Text="Facturar" onclick="guardar_Click"  onClientClick="espera();"></asp:button>&nbsp;
