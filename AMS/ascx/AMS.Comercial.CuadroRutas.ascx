...
<DIV align="center">
	<table style="WIDTH: 773px" align="center">
		...
		<tr>
			<td style="WIDTH: 139px" valign="top"><asp:label id="Label4" Font-Bold="True" Font-Size="XX-Small" runat="server">Código :</asp:label></td>
		...
		<tr>
			<td style="WIDTH: 139px"><asp:label id="Label5" Font-Bold="True" Font-Size="XX-Small" runat="server">Tipo de programación:</asp:label></td>
...
function CargarPlaca_Callback(response){
	...
	if(info && respuesta.Tables[0].Rows.length>0)
		document.getElementById('spnAjax').innerHTML="<table style='font-size:XX-Small;font-weight:bold;'><tr><td>Descripción:</td><td>"+respuesta.Tables[0].Rows[0].DESC+"</td></tr><tr><td>Origen:</td><td>"+respuesta.Tables[0].Rows[0].ORIG+"</td></tr><tr><td>Destino:</td><td>"+respuesta.Tables[0].Rows[0].DEST+"</td></tr></table>";	
	else{
		document.getElementById('spnAjax').innerHTML="";
		info=false;}
	info=true;
