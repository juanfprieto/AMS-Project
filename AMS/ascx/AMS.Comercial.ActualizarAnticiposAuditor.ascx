<%@ Control Language="c#" Debug="true" autoeventwireup="false" codebehind="AMS.Comercial.ActualizarAnticiposAuditor.ascx.cs" Inherits="AMS.Comercial.AMS_Comercial_ActualizarAnticiposAuditor" targetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
		...
		<tbody>
			<tr>
				<td colSpan="1"><b>Documento</b>
					<asp:textbox id="TextNumeroDocumento" runat="server"></asp:textbox></td>
				<td colSpan="2"><b>Placa:</b>
					<asp:textbox id="TxtPlaca" ondblclick="ModalDialog(this,'SELECT mcat_placa AS Placa, rtrim(char(mbus_numero)) as numero from DBXSCHEMA.mbusafiliado where testa_codigo>0 and testa_codigo <> 3', new Array(),1);TraerBus(this.value);"
						runat="server" Font-Size="XX-Small" MaxLength="6"></asp:textbox>
				...
				<td colSpan="5"><b>Responsable</b>
					<asp:textbox id="TxtResponsable" ondblclick="ModalDialog(this,'SELECT MNIT.MNIT_NIT AS NIT,MNIT.MNIT_NOMBRES CONCAT \' \'CONCAT coalesce(MNIT.MNIT_NOMBRE2,\'\') CONCAT \' \' CONCAT MNIT.MNIT_APELLIDOS CONCAT \' \' CONCAT coalesce(MNIT.MNIT_APELLIDO2,\'\') AS NOMBRE from DBXSCHEMA.MNIT MNIT', new Array(),1)"
						runat="server" Font-Size="XX-Small" ReadOnly="False"></asp:textbox>
				<td colSpan="6"><b>Fecha Inicial </b>
					<asp:textbox id="TextFechaI" onkeyup="DateMask(this)" runat="server"></asp:textbox></td>
				<td colSpan="6"><b>Fecha Final </b>
					<asp:textbox id="TextFechaF" onkeyup="DateMask(this)" runat="server"></asp:textbox></td>
				<td colSpan="7">
					<b>Planilla</b>
					<asp:textbox id="TextPlanilla" runat="server"></asp:textbox></td>
			</tr>
		</tbody>
	</table>
		...
		<tbody>
			<tr>
				<td  align="center" colSpan="1">
                    <asp:button id="btnBuscar" Font-Size="XX-Small" Font-Bold="True" Runat="server"
					Text="Buscar"></asp:button>
                </td>
			</tr>
			<tr>
				<td align="center" colSpan="1">
                    <B>OTROS INGRESOS-GASTOS-ANTICIPOS Y SERVICIOS:</B>
                </td>
			</tr>
		</tbody>
	</table>
	<asp:panel id="pnlAnticipos" Runat="server" Visible="False" Width="889px" Height="509px">
<asp:datagrid id="dgrAnticipos" runat="server" OnItemCommand="dgActualizarAnticipo"
