<%@ Control Language="c#" codebehind="AMS.Vehiculos.GastoDirectoVehiculos.ascx.cs" autoeventwireup="True" Inherits="AMS.Vehiculos.GastoDirectoVehiculos" %>
...
//        var nit = document.getElementById('<%=nitProveedor.ClientID%>');
...
//        ModalDialog(nombre, 'SELECT nombre  as Nombre FROM vmnit where mnit_nit=', new Array());
//
    //    }
    ...
    function cargarFech(ob) {
        return GastoDirectoVehiculos.ConsultarFecha(ob.value, ConsultarFecha_CallBack);
    }
    ...
    {
        GastoDirectoVehiculos.Cargar_Nombre(obj.value, Cargar_Nombre_CallBack);
    }
	...
	<table id="Table2" class="filtersIn">
		<tbody>
			<tr>
				...
				<td>
					Nit Proveedor :<br>
                    <asp:TextBox id="nitProveedor" ondblclick="ModalDialog(this,'SELECT mnit_nit as NIT, nombre  as Nombre FROM vmnit', new Array())"  onblur="Cargar_Nombre(this);"
                    class="tpequeno" runat="server"></asp:TextBox>
...
<asp:Panel ID="pnlDetalles" Runat="server" Visible="False">
	<TABLE class="main" style="WIDTH: 85%; HEIGHT: 46px" border="1">
		<TR>
			<TD class="SubTitulos" align="center">Vehiculos Relacionados</TD>
		...
		<TR>
				...
				<asp:DataGrid id="dgVehiculos" runat="server" cssclass="datagrid" OnEditCommand="gridNC_Edit" OnUpdateCommand="gridNC_Update" OnCancelCommand="gridNC_Cancel"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Valor de Factura">
                            ...
                            <EditItemTemplate>
				                <asp:TextBox runat="server" id="valorFac"  onkeyup="NumericMaskE(this,event)" CssClass="AlineacionDerecha" class="tpequeno" Text='<%# DataBinder.Eval(Container.DataItem, "VALORFACT" , "{0:C}") %>' />
			                </EditItemTemplate>
						</asp:TemplateColumn>
			...
			<TD>
				<asp:DataGrid id="dgGastos" runat="server" cssclass="datagrid" OnItemCommand="DgGastos_AddAndDel" ShowFooter="True" GridLines="Vertical" AutoGenerateColumns="false"
					OnCancelCommand="DgGastos_Cancel" OnUpdateCommand="DgGastos_Update" OnEditCommand="DgGastos_Edit"
					...
					<Columns>
						...
						<asp:TemplateColumn HeaderText="Valor Gasto">
							...
							<FooterTemplate>
								<asp:TextBox id="valorInserts" runat="server" class="tmediano" onkeyup="NumericMaskE(this,event)"></asp:TextBox>
							</FooterTemplate>
						</asp:TemplateColumn>
						<asp:TemplateColumn HeaderText ="Operaciones">
							<ItemTemplate>
		...
		<TR>
			<TD vAlign="top" align="center">
				<asp:DataGrid id="gridRtns" runat="server" cssclass="datagrid" Visible="True" AutoGenerateColumns="False"
					OnItemDataBound="gridRtns_ItemDataBound" showfooter="True" onItemCommand="gridRtns_Item">
					    <FooterStyle CssClass="footer"></FooterStyle>
						<HeaderStyle CssClass="header"></HeaderStyle>
						<PagerStyle CssClass="pager" mode="NumericPages"></PagerStyle>
						<SelectedItemStyle CssClass="selected"></SelectedItemStyle>
				...
				<FIELDSET>
					...
					<TABLE class="main">
						<TR>
							...
							<TD>
								<asp:TextBox id="tlVehiculos" runat="server" readonly="True">0</asp:TextBox></TD>
                            <td></td>
                            <td></td>
						</TR>
						<TR>
							...
							<TD vAlign="middle">
								<asp:TextBox id="tlGastos" runat="server" readonly="true">0</asp:TextBox></TD>
                            <td><asp:TextBox id="txtGastosVeh" runat="server" readonly="true">0</asp:TextBox></td>
...
function Cambio_Retencion(objDdlRete, objTxtcodret, tipoSociedad,porcentaje,base,valor) {
    ...
    $("#" + objTxtcodret.id).click(function () {
        ...
        if (tipoSociedad == "N" || tipoSociedad == "U" || tipoSociedad == "P") 
        {
