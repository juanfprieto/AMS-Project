	...
	<table id="Table2" class="filtersIn">
		<tbody>
			<tr>
				...
				<td>
					Nit Proveedor :<br>
                    <asp:TextBox id="nitProveedor" ondblclick="ModalDialog(this,'SELECT mnit_nit as NIT, nombre  as Nombre FROM vmnit', new Array())"  onblur="Cargar_Nombre(this);" OnTextChanged="Cargue_Documento"
