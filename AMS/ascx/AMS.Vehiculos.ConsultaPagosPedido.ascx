	...
	<table class="main" cellspacing="10">
		<tbody>
			<tr>
				...
				<td>
					<asp:Label id="lbInfo3" runat="server" forecolor="RoyalBlue">Tipo de Vehiculo :</asp:Label>&nbsp;<asp:Label id="catalogo" runat="server"></asp:Label></td>
			</tr>
			<tr>
				<td>
				...
				<td>
					<asp:Label id="lbInfo6" runat="server" forecolor="RoyalBlue">Clase Vehiculo :</asp:Label>&nbsp;<asp:Label id="claseVehiculo" runat="server"></asp:Label></td>
			</tr>
			<tr>
				<td>
