...
<table id="Table" class="filtersIn">
	<tbody>
        ...
        Empleado
                    <br />
                    <asp:dropdownlist id="DDLEMPLEADO" runat="server" class="dgrande"></asp:dropdownlist>
			<td>
					<tr>                    
...
<asp:Label id=LBVACAAPAGAR runat="server"></asp:Label></TD></TR>
  <TR>
    <TD>
      <P>Vlr. Interéses a Pagar : 
<asp:Label id=LBINTAPAGAR runat="server"></asp:Label></P></TD>
    <TD>
      <P>Vlr. Novedades: 
<asp:Label id=LBDESCUENTONOVEDADES runat="server"></asp:Label></P></TD>
    <TD>
      <P>(-) Vlr. Eps por Vacaciones: 
<asp:Label id=LBEPSVACACIONES runat="server"></asp:Label></P></TD></TR>
<tr>
   <TD> </TD>
    <TD> </TD>
    <td>
      <P>(-) Vlr. Pensión por Vacaciones: 
<asp:Label id=LBFONDOVACACIONES runat="server"></asp:Label></P></TD></tr>
<tr>
    <TD> </TD>
    <TD> </TD></TR></TABLE>
<P> </P>
