...
<script type ="text/javascript">
    function mostrarDialogo(obj) {
        ...
        ModalDialog(catalogo, 'SELECT PC.pcat_codigo CONCAT SUBSTR(MC.MCAT_VIN,(LENGTH(MC.MCAT_VIN)-2),3)  as pcat_codigo, MC.MCAT_VIN concat \' - \' concat  pMAR_NOMBRE concat \' - \'  concat pcat_descripcion as descripcion  ' +
