<%@ Page language="c#" Codebehind="AMS.Automotriz.PlanificacionTallerVeh.aspx.cs" AutoEventWireup="True" Inherits="AMS.Automotriz.AMS_Automotriz_PlanificacionTallerVeh" %>
<!DOCTYPE html>
<html lang="es">
<head>
    <meta charset="utf-8" />
    <link href="../css/planningStyVeh.css" type="text/css" rel="stylesheet" />
    <script type="text/javascript" src="../js/jquery.js"></script>
    <script type="text/javascript" src="../js/planningScroll.js"></script>
    <title>AMS - Planning de Vehículos </title>
</head>
<script type="text/javascript">
    var planning = 'vehiculos';
</script>
<body>
    <form id="Form2" method="post" runat="server">

        <table id="Table2" class="titulo">
	        <tr>
	        ...
	        <tr>
		        <td colspan="2">
                    ...
                    <div class="estverdemuyClaro">Cumplida</div>
		        </td>
        ...
        <div id="contImg">
            ...
            <label><font size="4"><i>e</i></font>CAS Procesando...</label>
        </div>
