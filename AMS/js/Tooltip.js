...
{ var isInit = -1;
  ...
  this.Show =  function(e,strHTML)
  {
    ...
    /*if((curPosx+divWidth+10)< width)newPosx= curPosx+10;else newPosx = curPosx-divWidth-10;if((curPosy+divHeight)< height)newPosy= curPosy; else newPosy = curPosy-divHeight-10;
    /*if(window.pageYOffset){newPosy= newPosy+ window.pageYOffset;newPosx = newPosx + window.pageXOffset;}else {newPosy= newPosy+ document.body.scrollTop;newPosx = newPosx + document.body.scrollLeft;}*/

    div.style.display='block';
    //debugger;
    div.style.top= (curPosy+document.body.scrollTop) + "px";
    div.style.left= (curPosx+document.body.scrollLeft) + "px";
    div.focus();
    if(animateToolTip){
