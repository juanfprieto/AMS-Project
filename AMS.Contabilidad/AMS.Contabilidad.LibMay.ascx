<%@ Control Language="c#" codebehind="AMS.Contabilidad.LibMay.ascx.cs" autoeventwireup="True" Inherits="AMS.Contabilidad.LibMay" %>
		...
		<p>
			<table class="reports" width="780" bgcolor="gray">
				<tbody>
					...
					<tr>
						<td>
							<ASP:DataGrid id="report" runat="server" cssclass="datagrid" OnItemDataBound="Report_ItemDataBound" autogeneratecolumns="false"
								AllowSorting="true">
