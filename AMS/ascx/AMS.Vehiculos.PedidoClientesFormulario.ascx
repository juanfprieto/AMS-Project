...
function mostrarDialogo() {
    ...
    ModalDialog(catalogo, 'SELECT DISTINCT pc.Pcat_codigo, pmar_nombre concat \'  -  \' concat pcat_descripcion concat \'  -  \' concat pc.pcat_codigo AS descripcion  ' +
	        ...
	        <table class="filtersIn" >
		        <tr>
		            <td>
                        ...
                        <asp:TextBox id="datosCliente" class="tmediano"         ondblclick="ModalDialog(this,'SELECT NIT.mnit_nit AS NIT, NIT.NOMBRE AS NOMBRE FROM Vmnit NIT WHERE NIT.mnit_nit NOT IN (SELECT PNI.pnital_nittaller FROM pnittaller PNI) AND NIT.mnit_nit NOT IN (SELECT CEM.mnit_nit FROM cempresa CEM) order by NOMBRE',new Array(),1)" onblur="Cargar_Nombre(this);VerificarCliente(this);" runat="server" ></asp:TextBox>
		        ...
		        <tr>
		            <td>
                        ...
                        <asp:TextBox id="datosClienteAlterno"  class="tmediano" ondblclick="ModalDialog(this,'SELECT NIT.mnit_nit AS NIT, NIT.NOMBRE AS NOMBRE FROM Vmnit NIT WHERE NIT.mnit_nit NOT IN (SELECT PNI.pnital_nittaller FROM pnittaller PNI) AND NIT.mnit_nit NOT IN (SELECT CEM.mnit_nit FROM cempresa CEM) order by NOMBRE',new Array(),1)" onblur="Cargar_Nombrea(this);" runat="server" ></asp:TextBox>
		        ...
		        <tr>
		            <td>
                        ...
                        <asp:TextBox id="datosClienteSolicita" class="tmediano" ondblclick="ModalDialog(this,'SELECT NIT.mnit_nit AS NIT, NIT.NOMBRE AS NOMBRE FROM Vmnit NIT WHERE NIT.mnit_nit NOT IN (SELECT PNI.pnital_nittaller FROM pnittaller PNI) AND NIT.mnit_nit NOT IN (SELECT CEM.mnit_nit FROM cempresa CEM) order by NOMBRE',new Array(),1)" onblur="Cargar_Nombreb(this);" runat="server" ></asp:TextBox>
            ...
            <asp:DataGrid id="grillaElementos" runat="server" cssclass="datagrid" OnItemCommand="dgEvento_Grilla" AutoGenerateColumns="false" GridLines="Vertical" ShowFooter="True" OnItemDataBound="dgAccesorioBound">
				...
				<Columns>
					...
					<asp:TemplateColumn HeaderText="DESCRIPCION">
						...
						<FooterTemplate>
							<asp:textbox id="obesequioTextBoxa" onclick="ModalDialog(this,'SELECT pite_codigo,pite_nombre,pite_costo,PTRA_CODIGO FROM DBXSCHEMA.pitemventavehiculo',new Array())" runat="server" ReadOnly="true"></asp:textbox>
						</FooterTemplate>
					</asp:TemplateColumn>
                            ...
                            <asp:DataGrid id="grillaRetoma" runat="server" cssclass="datagrid" OnItemCommand="dgEvento_Grilla_Retoma" AutoGenerateColumns="false" GridLines="Vertical" ShowFooter="True">
				                ...
				                <Columns>
					                <asp:TemplateColumn HeaderText="TIPO VEHICULO RETOMA">
						                ...
						                <FooterTemplate>
							                <asp:textbox id="tipoVehiculoRetoma" onclick="ModalDialog(this,'SELECT pcat_codigo AS Catalogo, pmar_nombre concat \' - \' concat pcat_descripcion AS Descripcion FROM dbxschema.pcatalogovehiculo pc,dbxschema.pmarca pm where pc.pmar_codigo = pm.pmar_codigo order by 2',new Array())" runat="server" ReadOnly="true" Width="100px"></asp:textbox>
						                </FooterTemplate>
					                </asp:TemplateColumn>
					                ...
					                <asp:TemplateColumn HeaderText="AÑO DE MODELO">
						                ...
						                <FooterTemplate>
							                <asp:textbox id="anoModeloRetoma" onclick="ModalDialog(this,'SELECT pano_ano FROM pano',new Array())" runat="server" ReadOnly="true" Width="100px"></asp:textbox>
						                </FooterTemplate>
					                </asp:TemplateColumn>
