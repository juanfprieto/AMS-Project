		...
		<table class="tablewhite" cellSpacing="1" cellPadding="1" border="0">
			...
			<tr>
				<td colSpan="2">Por favor genere un archivo de excel con las siguientes columnas<br>
					...
					<LI>
					    DEBITO : valor débito de renglón (valor numérico obligatorio sin separadores de mil, ni signos pesos, el decimal con coma) .
					<LI>
					    CREDITO : valor crédito de renglón (valor numérico obligatorio sin separadores de mil, ni signos pesos, el decimal con coma).
					<LI>
						BASE : valor base de renglón (valor numérico obligatorio sin separadores de mil, ni signos pesos, el decimal con coma).
					<LI>
					    DEBITONIIF : valor débito NIIF de renglón (valor numérico obligatorio sin separadores de mil, ni signos pesos, el decimal con coma).
					<LI>
					    CREDITONIIF : valor crédito NIIF de renglón (valor numérico obligatorio sin separadores de mil, ni signos pesos, el decimal con coma).<br>
					    Notas :
					<li>
					...
					<LI>
					    Debe seleccionar todo el espacio de datos del comprobante, ingresar por FORMULAS, dar click en Asignar Nombre y define el nombre COMPROBANTE (cambiando el de Cuenta que ahí le suguiere).
					<LI>
