<%@ Control Language="c#" AutoEventWireup="True" Codebehind="AMS.Cartera.ModificacionRetenciones.ascx.cs" Inherits="AMS.Finanzas.AMS_Cartera_ModificacionRetenciones" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
			...
			<TR>
				<TD>
					<asp:DataGrid id="gridRtns" runat="server" cssclass="datagrid" showfooter="True" OnItemDataBound="gridRtns_ItemDataBound"
						onItemCommand="gridRtns_Item" CellPadding="3" AutoGenerateColumns="False" OnCancelCommand="dgrItems_Cancel"
...
<asp:Label id="lblError" runat="server" Runat="server"></asp:Label>
