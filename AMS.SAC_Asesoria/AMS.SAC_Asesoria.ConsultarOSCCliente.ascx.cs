namespace AMS.SAC_Asesoria
{
    ...
    public partial class ConsultarOSCCliente : System.Web.UI.UserControl
    {

        //protected DropDownList ddlnumero;
        ...
        protected void Page_Load(object Sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                //bind.PutDatasIntoDropDownList(ddlnumero, "SELECT MORD.mord_numero FROM dbxschema.mordenservicio MORD,dbxschema.msolicitud MSOL WHERE MORD.msol_numero=MSOL.msol_numero AND MORD.TEST_CODIGO='AS' AND MORD.PAS_mnit_nit=(SELECT PASE_NIT FROM dbxschema.PASESORUSUARIO WHERE susu_codigo =(SELECT susu_codigo FROM dbxschema.susuario WHERE susu_login='" + HttpContext.Current.User.Identity.Name.ToLower() + "'))");
                bind.PutDatasIntoDropDownList(ddlnumero, "SELECT MORD.mord_numero FROM dbxschema.mordenservicio MORD,dbxschema.msolicitud MSOL WHERE MORD.msol_numero=MSOL.msol_numero AND (MORD.TEST_CODIGO='AS' OR MORD.TEST_CODIGO='ED') AND MORD.PAS_mnit_nit=(SELECT mnit_nit FROM dbxschema.susuario WHERE susu_login='" + HttpContext.Current.User.Identity.Name.ToLower() + "')");
