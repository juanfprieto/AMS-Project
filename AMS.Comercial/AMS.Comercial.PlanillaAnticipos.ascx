<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AMS.Comercial.PlanillaAnticipos.ascx.cs" Inherits="AMS.Comercial.AMS_Comercial_Planilla" TargetSchema="http://schemas.microsoft.com/intellisense/ie5" %>
					...
					<p>
						<TABLE id="Table1" cellSpacing="1" cellPadding="1" width="300" border="1">
							<TR>
								...
								<td><asp:dropdownlist id="Placa" runat="server" OnSelectedIndexChanged="generar" Width="136px"></asp:dropdownlist></TD>
							</TR>
							<TR>
							</TR>
						</TABLE>
			...
			<td align="center">
				<p><asp:datagrid id="Grid" runat="server" Width="780px" HorizontalAlign="Center" AutoGenerateColumns="False">
						...
						<Columns>
							...
							<asp:TemplateColumn HeaderText="NUMERO ANTICIPO" ItemStyle-HorizontalAlign="center">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "CODIGO") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="DESCRIPCION ANTICIPO" ItemStyle-HorizontalAlign="center">
								<ItemTemplate>
									<%# DataBinder.Eval(Container.DataItem, "DESCRIPCION") %>
								</ItemTemplate>
							</asp:TemplateColumn>
							<asp:TemplateColumn HeaderText="VALOR ANTICIPO" ItemStyle-HorizontalAlign="Right">
								<ItemTemplate>
