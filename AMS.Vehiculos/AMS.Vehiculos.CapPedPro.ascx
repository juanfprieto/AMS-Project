		...
		<tr>
			<td>
				<fieldset>
                   <p></p>
                      ...
                      Nit Proveedor : <asp:textbox id="nitProveedor" onclick="ModalDialog(this, 'SELECT t1.mnit_nit as NIT, t1.mnit_nombres CONCAT \' \' CONCAT t1.mnit_apellidos as NOMBRE from MNIT as t1, MPROVEEDOR as t2 WHERE t1.mnit_nit=t2.mnit_nit', new Array())"
						runat="server" ReadOnly="True" class="tmediano"></asp:textbox>
                  <p>Nombre Proveedor :&nbsp;
				...
				<fieldset>
					<legend>Fecha</legend>
					<p>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
						<asp:label id="fechaPedido" runat="server"></asp:label>
					</p>
				</fieldset><br />
                <fieldset>
                    <asp:label runat="server" text="Número de Comisión"></asp:label><br />
                    <asp:textbox id="txtNumComi" runat="server" onkeypress="return soloNumero(event, this)" class="tmediano"></asp:textbox>
                </fieldset>
			</td>
		</tr>
	</tbody>
