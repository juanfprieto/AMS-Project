...
<script type="text/javascript">
    function CambioTipoPago(/*dropdownlist*/obCmbTipPg, /*textbox*/obBanco, /*textbox*/obNumDocu, /*textbox*/obVal, /*textbox*/obValTasCmb, /*textbox*/obValBas, /*textbox*/obFech, /*textbox*/objBtn, /*label*/objlb, /*string*/consignacion, /*textbox*/obChequera,  /*textbox*/obRazon) {
    ...
    function Cargar_Consulta(/*textbox*/obj, /*dropdownlist*/controlTiposPagos, /*string*/tipoRecibo, /*tetxbox*/campoNumero, /*string*/numeros) {
        if (tipoRecibo == 'RC' || tipoRecibo == 'RP') {
            ...
            //    ModalDialog(obj, 'SELECT PCUE.pban_banco AS BANCO,PBAN.pban_nombre AS NOMBRE,PCUE.pcue_numero AS CUENTA,PCUE.pcue_codigo AS CODIGO FROM dbxschema.pcuentacorriente PCUE,dbxschema.pbanco PBAN WHERE PCUE.pban_banco=PBAN.pban_codigo AND PCUE.tvig_vigencia=\'V\'', new Array());
