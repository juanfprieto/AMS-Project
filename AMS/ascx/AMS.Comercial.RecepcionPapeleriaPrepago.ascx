<%@ Control Language="c#" AutoEventWireup="false" Codebehind="AMS.Comercial.RecepcionPapeleriaPrepago.ascx.cs" Inherits="AMS.Comercial.AMS_Comercial_RecepcionPapeleriaPrepago" TargetSchema="http://schemas.microsoft.com/intellisense/ie5"%>
