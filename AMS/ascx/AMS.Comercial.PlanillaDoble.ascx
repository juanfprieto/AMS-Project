...
<DIV align="center">
	<table style="WIDTH: 773px" align="center">
		<tr>
			<td style="WIDTH: 545px" colSpan="2"><b>Información de la ruta gemela:</b>
			</td>
		</tr>
		<TR>
			<TD style="WIDTH: 139px"><asp:label id="Label11" runat="server" Font-Size="XX-Small" Font-Bold="True">Ruta Principal:</asp:label></TD>
			<td><asp:textbox id="txtRutaP" onclick="ModalDialog(this,'SELECT MR.MRUT_CODIGO AS CODIGO, MR.MRUT_DESCRIPCION AS DESCRIPCION FROM DBXSCHEMA.MRUTAS MR WHERE MR.MRUT_CLASE=2 ORDER BY MR.MRUT_CODIGO', new Array(),1);TraerActual();"
					ReadOnly="True" Font-Size="XX-Small" runat="server" Width="80px"></asp:textbox>&nbsp;</TD>
		</TR>
		<TR>
			<TD style="WIDTH: 139px" vAlign="top">
				<asp:label id="Label1" Font-Bold="True" Font-Size="XX-Small" runat="server">Ruta Primera Planilla :</asp:label></TD>
			<td><asp:textbox id="txtRuta1" onclick="MostrarSubRutas(this)" Font-Size="XX-Small" runat="server"
					Width="80px" ReadOnly="True"></asp:textbox>&nbsp;</TD>
		</TR>
		<TR>
			<TD style="WIDTH: 139px" vAlign="top">
				<asp:label id="Label14" Font-Bold="True" Font-Size="XX-Small" runat="server">Ruta Segunda Planilla :</asp:label></TD>
			<td><asp:textbox id="txtRuta2" onclick="MostrarSubRutas(this)" Font-Size="XX-Small" runat="server"
					Width="80px" ReadOnly="True"></asp:textbox>&nbsp;</TD>
		</TR>
		<TR>
			<TD style="WIDTH: 139px" vAlign="top">
				<asp:label id="Label2" Font-Bold="True" Font-Size="XX-Small" runat="server">Codigo Interno Ruta Primera Planilla :</asp:label></TD>
			<td><asp:textbox id="txtRutaInt1" Font-Size="XX-Small" runat="server" Width="80px" MaxLength="10"></asp:textbox>&nbsp;</TD>
		</TR>
		<TR>
			<TD style="WIDTH: 139px" vAlign="top">
				<asp:label id="Label3" Font-Bold="True" Font-Size="XX-Small" runat="server">Codigo Interno Ruta Segunda Planilla :</asp:label></TD>
			<td><asp:textbox id="txtRutaInt2" Font-Size="XX-Small" runat="server" Width="80px" MaxLength="10"></asp:textbox>&nbsp;</TD>
		</TR>
		<TR>
			<td></TD>
			<TD align="left">
