namespace AMS.Comercial
{
	...
	/// </summary>
	public class AMS_Comercial_ActualizarAnticiposAuditor : System.Web.UI.UserControl
	{
		...
		protected void dgActualizarAnticipo(object sender, DataGridCommandEventArgs e) 
		{
			...
			if ((e.CommandName == "Imprimir") )
			{
				...
				Response.Redirect(indexPage+ "?process=Comercial.IngresosGastos" + "&path="+Request.QueryString["path"]+ "&comando=" +e.CommandName + "&Documento=" +documento + "&sql="+ViewState["QUERY"] + "&pagina="+ViewState["PAGINA"]+ "&auditor=1");
