			...
			<TD>
				<FIELDSET><LEGEND class="Legends">Factura</LEGEND>
					<TABLE>
						...
						<TR>
							<TD>
								<asp:Label id="Label7" runat="server" forecolor="RoyalBlue">Código Vendedor : </asp:Label></TD>
			...
			<TD>
				<FIELDSET><LEGEND class="Legends">Factura</LEGEND>
					<TABLE>
						...
						<TR>
							<TD>
								<asp:Label id="Label8" runat="server" forecolor="RoyalBlue">Código Vendedor : </asp:Label></TD>
							<TD align="right"><%=ViewState["COD_VENDEDOR"]%></TD>
							<TD>
			...
			<TD>
				<FIELDSET><LEGEND class="Legends">Factura</LEGEND>
					<TABLE>
						...
						<TR>
							<TD>
								<asp:Label id="Label15" runat="server" forecolor="RoyalBlue">Código Vendedor : </asp:Label></TD>
							<TD align="right"><%=ViewState["COD_VENDEDOR"]%></TD>
							<TD>
